...
VBoxManage createhd --size $DISK --filename C:\Jala\Devops\vm\test\disks\test_disk
vboxmanage storageattach $NAME --storagectl "SATA" --device 0 --port 0 --type hdd --medium C:\Jala\Devops\vm\disks\test_disk.vdi
